...
public class StringPair extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public String left;
  @Deprecated public String right;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: left = (String)value$; break;
    case 1: right = (String)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @return A new StringPair RecordBuilder
   */
  public static Builder newBuilder(StringPair other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StringPair>
    ...
    public StringPair build() {
      try {
        ...
        record.left = fieldSetFlags()[0] ? this.left : (String) defaultValue(fields()[0]);
        record.right = fieldSetFlags()[1] ? this.right : (String) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
